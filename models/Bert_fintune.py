...
class Model(object):
    ...
    def bert_embedding(self):
        # load bert embedding
        bert_config = modeling.BertConfig.from_json_file("../data/chinese_L-12_H-768_A-12/bert_config.json")  # where bert config file stores
