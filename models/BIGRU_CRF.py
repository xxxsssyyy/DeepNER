...
class Model(object):
    def __init__(self, config):
        ...
        lstm_outputs = self.biGRU_layer(lstm_inputs, self.lstm_dim, self.lengths)
    ...
    def biGRU_layer(self, lstm_inputs, lstm_dim, lengths, name=None):
        """
        ...
        with tf.variable_scope("char_BiGRU" if not name else name):
            ...
            for direction in ["forward", "backward"]:
                with tf.variable_scope(direction):
                    lstm_cell[direction] = tf.nn.rnn_cell.GRUCell(
                        lstm_dim)
