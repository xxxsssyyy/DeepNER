...
import numpy as np
from models.Bert_fintune import Model
from utils.loader import load_sentences, update_tag_scheme
from utils.loader import char_mapping, bert_tag_mapping
from utils.loader import augment_with_pretrained, prepare_bert_dataset
from utils.utils import get_logger, make_path, clean, create_bert_model, save_model
from utils.utils import print_config, save_config, load_config, test_ner
from utils.data_utils import load_word2vec, create_input, input_from_line, BertBatchManager

flags = tf.app.flags
flags.DEFINE_boolean("clean",       False,      "clean train folder")
flags.DEFINE_boolean("train",       False,      "Weather train the model")
...
flags.DEFINE_boolean("freeze_bert",       False,       "Weather to freeze bert Variables")
...
flags.DEFINE_boolean("zeros",       False,      "Weather replace digits with zero")
flags.DEFINE_boolean("lower",       True,       "Weather lower case")
...
def config_model(tag_to_id):
    ...
    config['freeze_bert'] = FLAGS.freeze_bert
